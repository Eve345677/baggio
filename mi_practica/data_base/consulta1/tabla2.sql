...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-11-2022 a las 00:13:57
...
(2, 'usu', '123', 'usu', 'usu@gmail.com'),
(5, 'usu2', 'qwe', 'usu2', 'usu2@gmail.com'),
(6, 'usu3', 'bmn', 'usu3', 'usu3@gmail.com');
...
--
ALTER TABLE `productos`
  MODIFY `prd_id` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT de la tabla `usuarios`
--
ALTER TABLE `usuarios`
  MODIFY `usu_id` int(1) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
COMMIT;
