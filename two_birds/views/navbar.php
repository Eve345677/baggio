...
<nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <div class="navbar-nav ms-auto py-0">
          <a href="index.php" class="nav-item nav-link <?php if($section == "home"){echo "active";} ?>">Home</a>
          <a href="forum.php" class="nav-item nav-link <?php if($section == "forum" || $section == "squeak"){echo "active";} ?>">Foro</a>
          <a href="donations.php" class="nav-item nav-link <?php if($section == "donations"){echo "active";} ?>">Como colaborar</a>
          <div class="nav-item dropdown">
            <a href="#" class="nav-link dropdown-toggle <?php if($section == "log_in" || $section == "my_profile" || $section == "register"){echo "active";} ?>" data-bs-toggle="dropdown"><i class="fa-solid fa-circle-user"></i></a>
