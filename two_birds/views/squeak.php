		...
		<div class="col-lg-8">
			...
			<article>
				...
				<header class="mb-4">
					...
					<!-- Post meta content-->
					<div class="text-muted fst-italic mb-2">Subido en <?php echo $resultado['mes'] . " " . $resultado['dia'] . ", " . $resultado['Year'] . " <a href='my_profile.php?id=".$propietario[0]['id']."'>por " . $propietario[0]['user_name'] . ".</a>" ?></div>
